        ...
        <CardContent>
          ...
          {status === "authenticated" && session && (
            <Alert className="mb-4">
              <AlertDescription>
                {t("auth.loggedInAs", { email: session.user?.email, provider: session.user?.provider })}
                <Button 
                  variant="link" 
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              ...
              {isLogin ? t("auth.loginWithFacebook") : t("auth.signupWithFacebook")}
            </Button>
            ...
            >
              ...
              {isLogin ? t("auth.loginWithStrava") : t("auth.signupWithStrava")}
            </Button>
