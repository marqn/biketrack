...
const BikePartsHistory: React.FC = () => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      alert(err instanceof Error ? err.message : tCommon("errorOccurred"));
    } finally {
      setDeleteId(null);
      setDeleteType(null);
    }
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center gap-2 ">
                  ...
                  <span className="text-sm font-medium">{tServices("serviceDate")}:</span>
                ...
                {service.lubricantBrand && (
                  <div className="flex items-center gap-2 ">
                    <SERVICE_ICON />
                    <span className="text-sm font-medium">{tServices("agent")}:</span>
                ...
                {service.notes && (
                  <div className="flex items-start gap-2  md:col-span-2">
                    ...
                    <div>
                      <span className="text-sm font-medium">{tServices("notes")}: </span>
