        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              >
                <span className="inline-flex items-center">
                  {t("bikes")} <SortIcon column="bikesCount" />
                </span>
              </TableHead>
              <TableHead
                className={headerClass}
              ...
              >
                <span className="inline-flex items-center">
                  {t("comments")} <SortIcon column="commentsCount" />
                </span>
              </TableHead>
              <TableHead
                className={headerClass}
              ...
              >
                <span className="inline-flex items-center">
                  {t("registration")} <SortIcon column="createdAt" />
                </span>
              </TableHead>
            ...
            {sorted.map((user) => (
              <TableRow key={user.id}>
                ...
                <TableCell>
                  ...
                  >
                    {user.plan === "PREMIUM" ? t("planPremium") : t("planFree")}
                  </Badge>
                </TableCell>
                ...
                <TableCell>
                  <div className="flex gap-1">
                    ...
                    <DeleteButton
                      id={user.id}
                      onDelete={deleteUser}
                      confirmMessage={t("confirmDeleteUser")}
                    />
                  </div>
                </TableCell>
              </TableRow>
